...
new_show_pdf = function(pdf_file_url){
    DEFAULT_URL = pdf_file_url;
    webViewerLoad();
}

show_pdf = function(pdf_file_url){
 PDFJS.getDocument(pdf_file_url).then(function(pdf) {
...
setup_pdf_viewer = function(){
    console.log("ran setup_pdf_viewer");
}
